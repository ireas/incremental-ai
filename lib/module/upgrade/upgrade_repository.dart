...
import 'package:incremental_ai/module/upgrade/model/upgrade/variant/scrap_capacity_upgrade.dart';
import 'package:incremental_ai/module/upgrade/model/upgrade/variant/scrap_multi_capacity_upgrade.dart';

/// Repository for Upgrade module.
class UpgradeRepository extends RepositoryArchetype with HasValidation, HasUpdate {
  /// Singleton instance.
