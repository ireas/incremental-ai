...
import 'package:incremental_ai/module/upgrade/model/upgrade/upgrade_state.dart';
import 'package:incremental_ai/module/upgrade/widget/upgrade_button.dart';
  ...
  Widget build(BuildContext context) {
    ...
    return SectionPanel(
      ...
      child: Column(
        spacing: 20,
        children: [
          Text("Upgrades", style: Theme.of(context).textTheme.headlineSmall),
          Column(
            spacing: 4,
            children: repository
                .fetchAll()
