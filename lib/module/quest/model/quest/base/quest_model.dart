...
import 'package:incremental_ai/module/quest/model/objective/objective_state.dart';
import 'package:incremental_ai/module/quest/model/quest/quest_state.dart';
...
abstract class QuestModel extends ChangeNotifier {
  ...
  QuestModel({required this.type, required this.objectives}) {
    id = "quest.${type.name}";
    labelName = Translator.instance.translate("$id.name");
  }
